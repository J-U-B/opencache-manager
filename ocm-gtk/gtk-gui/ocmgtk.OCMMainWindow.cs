...
namespace ocmgtk {
    ...
    public partial class OCMMainWindow {
        ...
        private Gtk.Action GitAction;

        private Gtk.Action OCM_Git_JUB_Action;

        private Gtk.Action OCM_Git_AP_Action;
        ...
        protected virtual void Build() {
            ...
            this.OCMHomePageAction = new Gtk.Action("OCMHomePageAction", Mono.Unix.Catalog.GetString("_OCM Home Page (legacy)..."), null, null);
            this.OCMHomePageAction.ShortLabel = Mono.Unix.Catalog.GetString("_OCM Home Page (legacy)...");
            w1.Add(this.OCMHomePageAction, null);

            this.GitAction = new Gtk.Action("GitAction", Mono.Unix.Catalog.GetString("Git"), null, null);
            this.GitAction.ShortLabel = Mono.Unix.Catalog.GetString("Git");
            w1.Add(this.GitAction, null);

            this.OCM_Git_JUB_Action = new Gtk.Action("OCM_Git_JUB_Action", Mono.Unix.Catalog.GetString("OCM on GitHub (Jens Böttge)"), null, null);
            this.OCM_Git_JUB_Action.ShortLabel = Mono.Unix.Catalog.GetString("OCM on GitHub (Jens Böttge)");
            w1.Add(this.OCM_Git_JUB_Action, null);            

            this.OCM_Git_AP_Action = new Gtk.Action("OCM_Git_AP_Action", Mono.Unix.Catalog.GetString("OCM on GitHub (Andreas Peters)"), null, null);
            this.OCM_Git_AP_Action.ShortLabel = Mono.Unix.Catalog.GetString("OCM on GitHub (Andreas Peters)");
            w1.Add(this.OCM_Git_AP_Action, null);        
            ...
            this.OCM_Git_JUB_Action.Activated += new System.EventHandler(this.OnOCM_Git_JUB_Click);
            this.OCM_Git_AP_Action.Activated += new System.EventHandler(this.OnOCM_Git_AP_Click);
            ...
            // Deactivate the follwing because it is currently not working:
            this.OCMWikiAction.Sensitive = false;
            this.OCMForumsAction.Sensitive = false;
            this.CheckForUpdatesAction.Sensitive = false;
        }
    }
}
